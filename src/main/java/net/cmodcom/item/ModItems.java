...
import net.cmodcom.item.custom.BundleItem;
import net.cmodcom.item.custom.SkulkPetrificationStoneItem;
...
public class ModItems {
    ...
    public static final Item SKULK_PETRIFICATION_STONE = registerItem("skulk_petrification_stone", new SkulkPetrificationStoneItem(new FabricItemSettings()));
    ...
    public static final Item CUSTOM_BUNDLE = registerItem("custom_bundle", new BundleItem(new FabricItemSettings().maxCount(1)));
